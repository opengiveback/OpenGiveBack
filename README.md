...
Both hardware and software open-source designs (in physical products) together add-up to the percentage of profit defined by an OpenGiveBack Repayment Tier. It is up to the **producer/seller** to define the exact division of this total OpenGiveBack percentage of profits to software and hardware design **author(s)/publisher(s)**, if they are different authors, based on the added value and indispensability as perceived by the **producer/seller**.
